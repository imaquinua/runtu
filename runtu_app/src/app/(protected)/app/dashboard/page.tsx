      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <button className="bg-white/5 hover:bg-white/10 border border-white/10 hover:border-accent/30 rounded-xl p-6 text-left transition-colors group">
        ...
        <div className="bg-gradient-to-r from-accent/10 to-accent/5 border border-accent/20 rounded-2xl p-8 text-center">
          ...
          <button className="bg-accent hover:bg-accent-dark text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors">
            Hablar con Runtu
          </button>
        </div>
      </main>
