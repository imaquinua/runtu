...
export function RuntuSuggestion() {
  return (
    <div className="bg-gradient-to-r from-indigo-50 to-white rounded-xl border border-indigo-100 p-5 md:p-6">
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0 p-2.5 bg-indigo-100 rounded-lg">
