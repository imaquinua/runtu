...
try {
  ...
  if (definition.output_schema.properties.agent_version.enum[0] !== '0.3.0' || !definition.instructions.includes('agent_version igual a 0.3.0')) {
  ...
  if (authorized.version !== '0.3.0' || authorized.checksum_sha256 !== checksum || authorized.eval_report_id !== null) {
  ...
  console.log(`PASS: deployment ${deployment.id.slice(0, 8)}… → v0.3.0; sesión/versión/pausa/cuota; run real sin contenido; feedback aislado.`);
} finally {
